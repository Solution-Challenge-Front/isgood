      ...
      <>
        <div className="container">
          <div className={'tuto' +" "+ state}>
            ...
            <button className='main-btns-join' onClick={() => { (tuto == 0) ? set_tuto(0) : set_tuto(tuto - 1) }}> 이전 </button>
            <button className='main-btns-join' onClick={() => { (tuto == 2) ? set_tuto(2) : set_tuto(tuto + 1)  }}> 다음 </button>
            </div>
